...
from src.views.customer_admin_form import ReservationForm
...
class CustomerAdminView(MyModelView):
    can_delete = True
    ...
    def create_form(self, obj=None):
        form = super(CustomerAdminView, self).create_form(obj)
    ...
    def edit_form(self, obj=None):
        form = super(CustomerAdminView, self).edit_form(obj)
        form.session = self.session
        form.user_role = current_user.role if current_user.is_authenticated else None  # Pass user role to form
    ...
    def on_model_change(self, form, model, is_created):
        ...
        return super(CustomerAdminView, self).on_model_change(form, model, is_created)
    ...
    def on_model_delete(self, model):
        ...
        return super(CustomerAdminView, self).on_model_delete(model)
    ...
    def render(self, template, **kwargs):
        ...
        return super(CustomerAdminView, self).render(template, **kwargs)
